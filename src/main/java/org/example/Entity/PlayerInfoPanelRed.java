...
public class PlayerInfoPanelRed {
    public int lives;
    public GamePanel gp;
    public int panelX;
    public int panelY;
    ...
    public PlayerInfoPanelRed(Player player , GamePanel gp){
        lives = player.lives;
    ...
    public void getImages(){
        try {
            ...
            playerImage = ImageIO.read(new File("res/Player/boy_red_right_1.png"));
        }
        catch (Exception e){
            e.printStackTrace();
        }
